...
namespace QuizTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("In game theory and economic theory, a zero-sum game is a mathematical representation of a situation in which each participant's gain or loss of utility is exactly balanced by the losses or gains of the utility of the other participants.");
            Console.WriteLine("");
            Console.WriteLine("Which of the following is a zero-sum game?");
            Console.WriteLine("");
            Console.WriteLine("1)Chess 2)Prisoners' dilemma 3) A cartel member's decision regarding whether or not to cheat 4)All of the above");
            ...
            Console.WriteLine("");
            Console.WriteLine("");
            Console.WriteLine("2.Game theory has many benefits and is a great way to solve problems but its not all perfect and there are some concerns with game theorists as well.");
            Console.WriteLine("");
            Console.WriteLine("Game theory is concerned with:");
            Console.WriteLine("");
            Console.WriteLine("1)predicting the results of bets placed on games like roulette 2)the choice of an optimal strategy in conflict situations 3)  utility maximization by rms in perfectly competitive markets. 4)the way in which a player can win every game.");
            Console.WriteLine("Answer : ");
            ...
            Console.WriteLine("\n3.Assuming Jack and Jill are at round 30. What would be the payoff at this round?");
            ...
            Console.WriteLine("");
            Console.WriteLine("\n\n4.Which scenario do you think both criminals would most benefit or end up? (draw a 2x2 box if needed)");
            Console.WriteLine("");
            ...
            Console.WriteLine("");
            Console.WriteLine("5.which choices are equilibriums in this example?");
